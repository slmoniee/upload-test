// [2023-12-13 16:10 Code[FIN] - GameFrame_Decoupling2.java]
// 점수처리, 메뉴 액션 등록, 결과 요약창 제작 필요
...
public class GameFrame_Decoupling2 extends JFrame {

   private JPanel GamePanelCommon;
   private JMenuItem pauseResumeMenuItem;
//   TransparentPanel TransparentPanel = new TransparentPanel();
//   NewGamePanelJava NewGamePanelJava = new NewGamePanelJava();

   GameFrame_Decoupling2() { // 생성자 정의
      ...
      NewGamePanelJava NewGamePanelJava = new NewGamePanelJava();
      add(NewGamePanelJava); // 그냥 더한다는 의미임 대략적으로. (필요할 때가 있지)
      NewGamePanelJava.setVisible(true);
...
//         repaint();
         ...
         // 새로운 TransparentPanel 생성 및 추가
          NewGamePanelJava newPanel = new NewGamePanelJava();
   ...
   private ActionListener exitActionListener = new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
         int result = JOptionPane.showConfirmDialog(GameFrame_Decoupling2.this, "게임을 종료하시겠습니까?", "게임 종료",
...
////----- ▲ 테스트 코드 영역
   ...
   public static void main(String[] args) {
      new GameFrame_Decoupling2(); // 객체 생성 (생성자 정의만 하면 안됩니다. 생성을 해야죠.)
